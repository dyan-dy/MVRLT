...
def _render(file_path, sha256, output_dir, views):
    hdr_dir_list = ['assets/blue_photo_studio_4k.exr']
    output_folder = os.path.join(output_dir, 'renders', sha256)
    args = [
        BLENDER_PATH, '-b', '-P', os.path.join(os.path.dirname(__file__), 'blender_script', 'blender_render.py'),
        '--',
...
if __name__ == '__main__':
    ...
    parser.add_argument('--output_dir', type=str, required=True, default='~/autodl-tmp/gaodongyu/multi_view_outputs',
    ...
    multi_pose = init_camera_pose(opt.num_views)
    # process objects
    func = partial(_render, output_dir=opt.output_dir, views=multi_pose)
